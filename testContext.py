...
def interface_context():
    ...
    try:
        submit_img = Image.open("iconSubmit.jpg")
        submit_button = CTkButton(master=window, text="Submit",fg_color="transparent",hover_color="#4b81ab", image=CTkImage(dark_image=submit_img),
                                border_width=2, border_color="#485188" ,command=submit_context, text_color="black")
        submit_button.grid(row=2, column=1, pady=10)
    except TclError as e:
        submit_button = CTkButton(master=window, text="Submit",fg_color="transparent",hover_color="#4b81ab",
                                border_width=2, border_color="#485188" ,command=submit_context, text_color="black")
        submit_button.grid(row=2, column=1, pady=10)
